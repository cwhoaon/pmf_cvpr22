...
from datasets import get_loaders, get_every_loaders
...
def main(args):
    ...
    data_loader_train, data_loader_val = get_every_loaders(args, num_tasks, global_rank) # chage for compatibility with caml
